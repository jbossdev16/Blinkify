      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-12 md:col-span-4 lg:col-span-4">
            ...
            <p className="mt-4 text-body-sm text-muted-foreground max-w-[280px] leading-relaxed">
              Generate high-quality product images and ad creatives in seconds
              with AI.
            </p>
            <div className="flex items-center gap-4 mt-6">
              <a
                href="https://x.com/blinkifyai"
                target="_blank"
              ...
              <a
                href="https://instagram.com/blinkify.ai"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="mt-16 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-body-sm text-muted-foreground">
              Made with AI for creators who move fast.
            </p>
          </div>
        </div>
      </div>
