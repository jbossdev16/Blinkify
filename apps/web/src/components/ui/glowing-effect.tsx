          ...
          style={
            {
              ...
              "--gradient":
                variant === "white"
                  ...
                  from 236.84deg at 50% 50%,
                  #0079d0 0%,
                  #9e52d8 calc(25% / var(--repeating-conic-gradient-times)),
                  #da365c calc(50% / var(--repeating-conic-gradient-times)),
                  #d04901 calc(75% / var(--repeating-conic-gradient-times)),
                  #0079d0 calc(100% / var(--repeating-conic-gradient-times))
                )`
