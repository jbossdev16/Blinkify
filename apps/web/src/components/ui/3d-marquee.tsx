                ...
                {subarray.map((image, imageIndex) => (
                  <div className="relative" key={imageIndex + image}>
                    ...
                    <motion.img
                      ...
                      src={image}
                      alt={image.split("/").pop()?.replace(/%20/g, " ").replace(/\.[^.]+$/, "") ?? "Ad creative"}
                      className={cn(
                        "rounded-lg object-cover ring-3 ring-gray-950/5 hover:shadow-2xl",
                        aspectRatio === "9/16" ? "aspect-[9/16]" : "aspect-970/700"
                      )}
                      width={aspectRatio === "9/16" ? 360 : 970}
                      height={aspectRatio === "9/16" ? 640 : 700}
                    />
                  </div>
                ))}
              </motion.div>
